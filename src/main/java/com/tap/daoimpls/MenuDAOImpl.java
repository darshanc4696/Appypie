...
public class MenuDAOImpl implements MenuDAO
{
	...
	private static final String SELECT_SPECIFIC_MENU = "select * from menu where menuId=? and restaurantId=?";
	...
	@Override
	public Menu fetchSpecificMenuItem(int menuId, int restaurantId) 
	{
		try
		{
